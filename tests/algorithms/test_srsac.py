...
class TestSRSAC(object):
    ...
    def test_run_online_rnn_training(self):
        ...
        config.batch_size = 2
        srsac = A.SRSAC(
            dummy_env, config=config, q_function_builder=RNNCriticBuilder(), policy_builder=RNNActorBuilder()
        )
    ...
    def test_latest_iteration_state(self):
        ...
        srsac._q_function_trainer_state = {"q_loss": 0.0, "td_errors": np.array([0.0, 1.0])}
        srsac._policy_trainer_state = {"pi_loss": 1.0}
...
class TestEfficientSRSAC:
    ...
    def test_latest_iteration_state(self):
        ...
        srsac._actor_critic_trainer_state = {"q_loss": 0.0, "td_errors": np.array([0.0, 1.0]), "pi_loss": 1.0}
