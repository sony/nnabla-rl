...
def create_expert_normalized_score_file(histograms, file_outdir, d4rl_env_name):
    iteration_nums = None
    returns_list = None
...
def to_d4rl_env_name(env_name):
    if 'HalfCheetah' in env_name:
        ...
        task_name = 'walker2d'
    # fix to medium dataset
    return f'{task_name}-medium-v2'
...
def compile_results(args):
    ...
    for env_name, histograms in histograms.items():
        ...
        d4rl_env_name = to_d4rl_env_name(env_name)
        create_expert_normalized_score_file(histograms, file_outdir, d4rl_env_name)
