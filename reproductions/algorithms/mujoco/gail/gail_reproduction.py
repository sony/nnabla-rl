...
def run_training(args):
    ...
    gail.train_online(train_env, total_iterations=args.total_iterations)
...
def run_showcase(args):
    ...
    gail = serializers.load_snapshot(
        args.snapshot_dir,
        eval_env,
        algorithm_kwargs={"config": config, "expert_buffer": ReplacementSamplingReplayBuffer()},
    )
...
def main():
    ...
    parser.add_argument("--total_iterations", type=int, default=25000000)
