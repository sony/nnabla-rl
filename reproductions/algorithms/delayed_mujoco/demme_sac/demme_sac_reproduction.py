...
def select_total_iterations(env_name):
    if env_name in ["DelayedHpper-v1"]:
...
def select_alpha_q(env_name):
    if env_name in ["DelayedHopper-v1"]:
        alpha_q = 2.0
    elif env_name in ["DelayedHalfCheetah-v1"]:
        alpha_q = 2.0
    elif env_name in ["DelayedWalker2d-v1"]:
        alpha_q = 2.0
    elif env_name in ["DelayedAnt-v1"]:
        alpha_q = 0.1
    else:
        alpha_q = 1.0
