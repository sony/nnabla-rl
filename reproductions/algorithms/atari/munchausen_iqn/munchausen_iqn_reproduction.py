...
def run_training(args):
    ...
    eval_env = build_atari_env(args.env, test=True, seed=args.seed + 100, use_gymnasium=args.use_gymnasium)
    ...
    m_iqn.train(train_env, total_iterations=args.total_iterations)
...
def run_showcase(args):
    ...
    config = A.MunchausenIQNConfig(gpu_id=args.gpu)
    m_iqn = serializers.load_snapshot(args.snapshot_dir, eval_env, algorithm_kwargs={"config": config})
