...
def run_training(args):
    ...
    ddqn = A.DDQN(train_env, config=config, replay_buffer_builder=MemoryEfficientBufferBuilder())
    ddqn.set_hooks(hooks=[iteration_num_hook, save_snapshot_hook, evaluation_hook])

    ddqn.train(train_env, total_iterations=args.total_iterations)
