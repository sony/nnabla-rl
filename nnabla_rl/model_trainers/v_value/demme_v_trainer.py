...
@dataclass
class DEMMEVTrainerConfig(SquaredTDVFunctionTrainerConfig):
    pass


class DEMMEVTrainer(SquaredTDVFunctionTrainer):
    ...
    def __init__(self,
                 ...
                 config: DEMMEVTrainerConfig = DEMMEVTrainerConfig()):
        ...
        super(DEMMEVTrainer, self).__init__(train_functions, solvers, env_info, config)
    ...
    def _compute_target(self, training_variables: TrainingVariables, **kwargs):
        ...
        sampled_action = policy_distribution.sample()
