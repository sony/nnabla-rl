...
class DefaultSolverBuilder(SolverBuilder):
    def build_solver(  # type: ignore[override]
        self, env_info: EnvironmentInfo, algorithm_config: DQNConfig, **kwargs
    ) -> nn.solver.Solver:
        ...
        solver = NS.RMSpropGraves(
            lr=algorithm_config.learning_rate, decay=decay, momentum=momentum, eps=min_squared_gradient
        )
        return solver
